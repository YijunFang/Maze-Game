 ...
 * set the player's position to be one coordinate downwards to its
 * current position
 */
...
/**
 * Moves the current position of the player one coordinate to the left.
 * Firstly, it ensures that the current position of the player is not
 * already at the left-most coordinate of the maze. If it isn't then
 * set the player's position to be one coordinate to the left of its
 * current position
 */
...
/**
 * Moves the current position of the player one coordinate upwards
 * Firstly, it ensures that the current position of the player is not
 * already at the top coordinate of the maze. If it isn't then
 * set the player's position to be one coordinate upwards of its
 * current position.
 */
...
/**
 * Moves the current position of the player one coordinate to the right
 * Firstly, it ensures that the current position of the player is not
 * already at the right-most coordinate of the maze. If it isn't then
 * set the player's position to be one coordinate to the right of its
 * current position.
 */
